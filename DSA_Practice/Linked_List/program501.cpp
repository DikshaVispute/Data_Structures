...
int main()
{
    ...
    while(1)
    {
        ...
        cout<<"2 : Delete the element into the queue\n";
        cout<<"3 : Display the elements of the queue\n";
        cout<<"4 : count the elements of the queue\n";
        ...
        switch(iChoice)
        {
            ...
            case 4:
                iRet = qobj->Count();
                cout<<"Number of elements of queue are : "<<iRet<<"\n";
                break;
            ...
            default:
                cout<<"Please enter the valid answer\n";
        }  // End of switch
    }  // End of while
